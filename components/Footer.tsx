            ...
            <div className="mt-6 sm:mt-8">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <a
                  ...
                  aria-label="Follow JKKN College of Nursing on Facebook"
                >
                ...
                <a
                  ...
                  rel="nofollow noopener noreferrer"
                  className="w-10 h-10 bg-[#1B8B4B] rounded-full flex items-center justify-center hover:bg-[#25a55c] transition-colors"
                  aria-label="Follow JKKN College of Nursing on Instagram"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="nofollow noopener noreferrer"
                  className="w-10 h-10 bg-[#1B8B4B] rounded-full flex items-center justify-center hover:bg-[#25a55c] transition-colors"
                  aria-label="Connect with JKKN College of Nursing on LinkedIn"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="nofollow noopener noreferrer"
                  className="w-10 h-10 bg-[#1B8B4B] rounded-full flex items-center justify-center hover:bg-[#25a55c] transition-colors"
                  aria-label="Watch JKKN College of Nursing videos on YouTube"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
