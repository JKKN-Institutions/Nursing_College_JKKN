      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 md:mb-8 text-[#FFD700] drop-shadow-2xl leading-tight px-4 max-w-6xl mx-auto">
            JKKN College of Nursing and Research <span className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-2">Sresakthimayeil Institute Of Nursing And Research</span>
          </h1>
