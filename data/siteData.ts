    ...
    submenu: [
      ...
      { label: "IIC", href: "/pdf/IIC.pdf", target: "_blank" },
      {
        ...
        submenu: [
          ...
          { label: "Why Komarapalayam Learners?", href: "/komarapalayam" },
          { label: "Why Bhavani Learners?", href: "/bhavani" },
          { label: "Why Tiruchengode Learners?", href: "/tiruchengode" },
          { label: "Why Gobichettipalayam Learners?", href: "/gobichettipalayam" },
          { label: "Why Sankagiri Learners?", href: "/sankagiri" },
          { label: "Why Rasipuram Learners?", href: "/rasipuram" },
          { label: "Why Karur Learners?", href: "/karur" },
          { label: "Why Dharmapuri Learners?", href: "/dharmapuri" },
          { label: "Why Krishnagiri Learners?", href: "/krishnagiri" },
          { label: "Why Attur Learners?", href: "/attur" },
          { label: "Why Mettur Learners?", href: "/mettur" },
          { label: "Why Edappadi Learners?", href: "/edappadi" },
          { label: "Why Perundurai Learners?", href: "/perundurai" },
          { label: "Why Sathyamangalam Learners?", href: "/sathyamangalam" },
          { label: "Why Kangeyam Learners?", href: "/kangeyam" },
        ],
      },
    ],
  },
