 ...
 * Regenerate:  python scripts/tn_nursing_dataset.py   (in the SEO project)
 * Verify:      python scripts/tn_nursing_dataset.py --check
 *
...
/** The institution code this college holds on the university's list. */
export const JKKN_CODE = "262";

const RAW: Array<[string, TnCollege[]]> = [
  ["Chengalpattu", [
    { code: "1047", name: "Chennais Amirta Nursing College", place: "Chengalpattu", seats: 60 },
  ...
  ["Coimbatore", [
    ...
    { code: "1044", name: "AMC College of Nursing", place: "Coimbatore", seats: 60 },
    ...
    { code: "977", name: "Ennam College of Nursing", place: "Coimbatore", seats: 60 },
    ...
    { code: "805", name: "Hindusthan College of Nursing", place: "Coimbatore", seats: 60 },
    ...
    { code: "964", name: "Nehru College of Nursing and Research Institute", place: "Coimbatore", seats: 60 },
    ...
    { code: "298", name: "RVS College of Nursing", place: "Coimbatore", seats: 50 },
  ...
  ["Cuddalore", [
    ...
    { code: "920", name: "Kamarajar College of Nursing", place: "Cuddalore", seats: 60 },
  ...
  ["Dharmapuri", [
    ...
    { code: "1099", name: "E.R.K. College of Nursing", place: "Dharmapuri", seats: 60 },
    { code: "978", name: "Mullai College of Nursing", place: "Dharmapuri", seats: 60 },
  ...
  ["Dindigul", [
    ...
    { code: "922", name: "Claudine College of Nursing", place: "Dindigul", seats: 60 },
    { code: "813", name: "GTN College of Nursing", place: "Dindigul", seats: 100 },
    { code: "229", name: "Jainee College of Nursing", place: "Dindigul", seats: 50 },
    { code: "912", name: "NPR College of Nursing & Research Institute", place: "Dindugul", seats: 60 },
    { code: "1104", name: "Our Lady College of Nursing Academic block in", place: "Dindigul", seats: 60 },
    { code: "545", name: "Sacred Heart College of Nursing", place: "Dindigul", seats: 50 },
    { code: "841", name: "Sai Sakthi College of Nursing", place: "Dindigul", seats: 60 },
  ...
  ["Erode", [
    ...
    { code: "216", name: "College of Nursing, Dharmarathnakara Dr. Mahalingam Institute of Paramedical Sciences and Research", place: "Sakthi Nagar", seats: 50 },
    ...
    { code: "1065", name: "Sri Sai Sindhu College of Nursing", place: "Gobichettipalayam", seats: 60 },
  ...
  ["Kallakurichi", [
    { code: "877", name: "London College of Nursing", place: "Kallakurichi", seats: 60 },
  ]],
  ["Kancheepuram", [
    ...
    { code: "378", name: "Karpaga Vinayaga College of Nursing", place: "Kancheepuram", seats: 100 },
    ...
    { code: "966", name: "PSP Nursing College", place: "Kancheepuram", seats: 100 },
  ...
  ["Kanyakumari", [
    ...
    { code: "311", name: "Global College of Nursing", place: "Kanyakumari", seats: 100 },
    { code: "538", name: "Grace College of Nursing", place: "Kanyakumari", seats: 50 },
    { code: "1067", name: "Immanuel Arasar College of Nursing", place: "Kanyakumari", seats: 60 },
    { code: "842", name: "Maria College of Nursing", place: "Moovattumugam", seats: 60 },
    { code: "301", name: "P.S. College of Nursing", place: "Kanyakumari", seats: 50 },
    ...
    { code: "299", name: "Thasiah College of Nursing", place: "Kanyakumari", seats: 60 },
    { code: "544", name: "The Salvation Army Catherine Booth College of Nursing", place: "Kanyakumari", seats: 50 },
    { code: "300", name: "White Memorial College of Nursing", place: "Kanyakumari", seats: 100 },
  ]],
  ["Karur", [
  ...
  ["Madurai", [
    ...
    { code: "1103", name: "Solai College of Nursing T. Chettiapatti Village", place: "Madurai", seats: 60 },
  ...
  ["Mayiladuthurai", [
    { code: "880", name: "Kalaimahal College of Nursing", place: "Mayiladuthurai", seats: 60 },
  ]],
  ["Nagapattinam", [
  ...
  ["Namakkal", [
    ...
    { code: "919", name: "K.S.Rangasamy College of Nursing", place: "Tiruchengode", seats: 60 },
    { code: "666", name: "Paavai College of Nursing and Research", place: "Namakkal", seats: 60 },
    { code: "230", name: "PGP. College of Nursing & Research", place: "Namakkal", seats: 50 },
    { code: "934", name: "Sengunthar College of Nursing", place: "Tiruchengode", seats: 60 },
    { code: "262", name: "Sresakthimayeil Institute of Nursing & Research", place: "Namakkal", seats: 60 },
    { code: "1008", name: "Sri Rengeswarar College of Nursing", place: "Namakkal", seats: 50 },
    { code: "097", name: "Vivekanandha College of Nursing", place: "Tiruchengode", seats: 100 },
  ]],
  ["Nilgiris", [
  ...
  ["Pudukkottai", [
    ...
    { code: "322", name: "Keerai Thamilselvan College of Nursing", place: "Pudukottai", seats: 50 },
    { code: "658", name: "Mother Teresa College of Nursing", place: "Pudukkottai", seats: 100 },
    { code: "331", name: "Mount Zion College of Nursing", place: "Pudukottai", seats: 50 },
  ]],
  ["Ranipet", [
    { code: "1107", name: "Sandhya College of Nursing at Nandiyalam", place: "Ranipet", seats: 60 },
  ...
  ["Salem", [
    ...
    { code: "620", name: "Sri Krishna Institute of Nursing Education and Research", place: "Omalur", seats: 50 },
    ...
    { code: "938", name: "Tharamangalam Sengunthar College of Nursing", place: "Tharamangalam", seats: 60 },
    { code: "882", name: "The Kaavery Nursing College", place: "Mettur", seats: 60 },
    { code: "235", name: "Vivekananda Nursing College For Women", place: "Sankari", seats: 100 },
  ]],
  ["Sivaganga", [
  ...
  ["Tenkasi", [
    ...
    { code: "1075", name: "St. Mary’s Institute of Nursing", place: "Tenkasi", seats: 60 },
  ...
  ["Thanjavur", [
    ...
    { code: "392", name: "St. Xavier College of Nursing", place: "Thanjavur", seats: 100 },
  ]],
  ["Theni", [
    ...
    { code: "742", name: "N.R.T. College of Nursing", place: "ThenI", seats: 100 },
  ...
  ["Thoothukudi", [
    ...
    { code: "991", name: "Parimala College of Nursing", place: "Tuticorin", seats: 60 },
  ...
  ["Tiruchirappalli", [
    ...
    { code: "935", name: "Mariamman Nursing College", place: "Trichy", seats: 60 },
    ...
    { code: "997", name: "Sri Amman College of Nursing", place: "Trichy", seats: 60 },
    { code: "1020", name: "Srinivasan Institute of Nursing", place: "Trichy", seats: 100 },
    { code: "726", name: "SRM Trichy College of Nursing Aykudi - Village", place: "Tiruchirappalli", seats: 100 },
  ]],
  ["Tirunelveli", [
    { code: "337", name: "Aladi Aruna College of Nursing", place: "Tirunelveli", seats: 60 },
    ...
    { code: "341", name: "CSI Eliza Caldwell College of Nursing", place: "Tirunelveli", seats: 50 },
    ...
    { code: "1050", name: "St.John’s College of Nursing", place: "Tirunelveli", seats: 60 },
    { code: "849", name: "St.Mariam College of Nursing", place: "Tirunelveli", seats: 60 },
  ]],
  ["Tiruppur", [
    ...
    { code: "942", name: "P.S.G. Ponnammaal College of Nursing", place: "Tirupur", seats: 60 },
    { code: "623", name: "Revathi College of Nursing", place: "Tirupur", seats: 100 },
    ...
    { code: "278", name: "Shivparvathi Mandradiar Institute of Health Sciences", place: "Tirupur", seats: 50 },
  ]],
  ["Tiruvallur", [
    { code: "1001", name: "Dr. MKL Nursing College", place: "Thiruvallur", seats: 60 },
  ...
  ["Vellore", [
    ...
    { code: "871", name: "Atthi Nursing College", place: "Vellore", seats: 60 },
  ...
  ["Viluppuram", [
    ...
    { code: "330", name: "Pauls College of Nursing", place: "Villupuram", seats: 50 },
    { code: "816", name: "PKB College of Nursing", place: "Villupuram", seats: 60 },
    { code: "1000", name: "Rangapoopathi Nursing College", place: "Villupuram", seats: 60 },
    { code: "318", name: "Sri Rangapoopathi College of Nursing", place: "Vilupuram", seats: 100 },
  ]],
  ["Virudhunagar", [
    { code: "878", name: "Rathinaam College of Nursing", place: "Virudhunagar", seats: 60 },
    { code: "309", name: "Suran College of Nursing", place: "Virudhunagar", seats: 50 },
    { code: "534", name: "V.P.M.M. College of Nursing", place: "Virudhunagar", seats: 50 },
  ]],
...
export const TN_UNSTATED_LABEL = "District not stated in the source";
...
export const TN_TOTALS = {
  ...
  districts: TN_DISTRICTS.filter((d) => d.district !== TN_UNSTATED_LABEL).length,
};

/** One district by name, or undefined. */
export function tnDistrict(name: string): TnDistrict | undefined {
  return TN_DISTRICTS.find((d) => d.district === name);
}

/**
 * One district by name, or a build failure.
 *
 * A district page cannot render a table for a district that is not in the dataset, so
 * the honest outcome is a failed build rather than a live page with an empty table and
 * a heading still claiming a count. Throwing here rather than at each call site also
 * keeps the return type non-optional, which a module-scope `if (!x) throw` does not.
 */
export function requireTnDistrict(name: string): TnDistrict {
  const d = tnDistrict(name);
  if (!d) {
    throw new Error(
      `District "${name}" is not in the TNMGRMU dataset - regenerate ` +
        "data/tn-nursing-colleges-2026-27.ts from the university list.",
    );
  }
  return d;
}
