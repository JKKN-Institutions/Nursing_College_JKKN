...
const config: CityPageConfig = {
  ...
  heroDescription:
    "Searching for a nursing college near Krishnagiri? Sresakthimayeil Institute Of Nursing And Research (JKKN College of Nursing and Research) in Komarapalayam is around 163 km away via Salem on the NH-44/NH-544 corridor — a Tamil Nadu option under The Tamil Nadu Dr. M.G.R. Medical University, with INC-approved programmes and secure hostels.",
  heroStats: [
    { value: "98%", label: "PLACEMENTS 2024-25" },
    { value: "₹3.6", label: "LPA MEDIAN (NIRF)" },
    { value: "163 km", label: "FROM KRISHNAGIRI" },
    { value: "3", label: "PROGRAMMES" },
  ],
  distanceKm: "~150",
  distanceHeading: "From Krishnagiri to JKKN Nursing",
  distanceSub:
    "about 3 hours by road — NH-44 to Salem, then NH-544 towards Erode; the campus is at Natarajapuram, Komarapalayam",
  ...
  landscapeParagraphs: [
    ...
    "For nursing aspirants, staying within Tamil Nadu has real advantages — Tamil Nadu state counselling, affiliation under The Tamil Nadu Dr. M.G.R. Medical University, and clinical postings in Tamil-speaking hospitals. JKKN College of Nursing and Research (Sresakthimayeil Institute Of Nursing And Research) at Komarapalayam offers exactly that, around 163 km from Krishnagiri along the well-served NH-44/NH-544 corridor via Salem.",
  ...
  faqs: [
    {
      ...
      a: "Sresakthimayeil Institute Of Nursing And Research (JKKN College of Nursing and Research) at Komarapalayam is an accessible INC-approved nursing college for Krishnagiri learners — around 163 km via Salem on the NH-44/NH-544 corridor. It is NAAC accredited and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai.",
    },
    {
      q: "How far is JKKN Nursing from Krishnagiri?",
      a: "JKKN College of Nursing and Research is roughly 163 km from Krishnagiri — about 3 hours by road. Take a Salem-bound bus on NH-44, then any NH-544 bus towards Erode; the campus is on the highway at Komarapalayam.",
    },
    {
      q: "Why study nursing in Tamil Nadu instead of Bangalore for Krishnagiri learners?",
      a: "Studying within Tamil Nadu keeps you in the Tamil Nadu state counselling system, under The Tamil Nadu Dr. M.G.R. Medical University, with clinical postings in Tamil-speaking hospitals — factors many Krishnagiri families prefer over crossing into Karnataka. JKKN College of Nursing and Research offers all three with INC approval and NAAC accreditation.",
    },
    {
  ...
  cities: [
    { name: "Dharmapuri", distance: "111 km", href: "/dharmapuri" },
...
export const metadata: Metadata = {
  ...
  description:
    "JKKN College of Nursing and Research at Komarapalayam is about 163 km from Krishnagiri via Salem. TNMGRMU affiliated, INC approved. B.Sc, M.Sc, Post Basic.",
  keywords:
  ...
  openGraph: {
    title: "Nursing College near Krishnagiri | B.Sc Nursing — JKKN",
    description:
      "JKKN College of Nursing and Research in Komarapalayam is 163 km from Krishnagiri via Salem. TN counselling, TNMGRMU affiliation, INC approved, secure hostels.",
