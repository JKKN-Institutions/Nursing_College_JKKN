            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4 mb-12">
                  <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=pbsc-nursing" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
                    Apply Now
                    <span>→</span>
                  </a>
                  <button
          ...
          <div className="container-custom">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=pbsc-nursing" target="_blank" rel="noopener noreferrer" className="bg-white text-[#006837] hover:bg-gray-100 font-semibold px-8 py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
                  Apply Now
                  <span>→</span>
                </a>
