...
export default function NewPostForm({ userEmail, userName, userAvatar, categories, tags }: Props) {
  ...
  async function uploadCoverImage(): Promise<string> {
    ...
    if (error) { toast.error('Cover image upload failed: ' + error.message); return ''; }
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Create a new blog post with rich content</p>
          </div>
        </div>
