...
export const metadata: Metadata = {
  title: "NIRF Rankings — JKKN College of Nursing and Research",
  description:
    "NIRF national ranking data and annual performance metrics of JKKN College of Nursing and Research.",
  openGraph: {
    title: "NIRF Rankings — JKKN College of Nursing and Research",
    description:
      "NIRF national ranking data and annual performance metrics of JKKN College of Nursing and Research.",
