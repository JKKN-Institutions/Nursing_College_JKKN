      ...
      <main className="bg-[#FBFBEE] min-h-screen pt-28">
        ...
        <div className="bg-[#FBFBEE] py-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-16 max-w-[1400px]">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-4 sm:mb-6">Anti-Sexual Harassment Policy — JKKN College of Nursing and Research</h1>
