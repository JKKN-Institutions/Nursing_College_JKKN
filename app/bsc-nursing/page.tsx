...
// The single source of truth for this page's FAQs. The page renders these AND the FAQPage
// JSON-LD below is generated from them, so the schema can never assert a question the page
// does not show. Previously the schema carried its own 6 differently-worded questions, of
// which only 1 appeared in the rendered DOM.
          ...
          __html: JSON.stringify([
            {
              ...
              "offers": {
                ...
                "priceCurrency": "INR",
                "offerCount": "2",
                "description": "Management quota annual tuition fee, academic year 2026-27: Rs 1,50,000 for female candidates, Rs 1,75,000 for male candidates. Government quota fees are as per Tamil Nadu government and university norms.",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div>
                ...
                <div className="bg-white/10 border-l-4 border-[#7cb983] p-4 mb-8 rounded-r-lg course-overview">
                  ...
                  <p className="text-gray-200 text-sm">JKKN College of Nursing and Research offers a 4-year INC-approved BSc Nursing program in Tamil Nadu, affiliated to Tamil Nadu Dr. M.G.R. Medical University. Learners receive clinical training at the attached 500+ bed multi-specialty teaching hospital from Year 1. 98% placement rate with international opportunities in NHS UK, UAE, and Singapore. Annual fee: ₹1,50,000 (female) / ₹1,75,000 (male).</p>
                </div>
                ...
                <div className="flex flex-wrap gap-4 mb-12">
                  <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=bsc-nursing" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
                    Apply Now
                    <span>→</span>
                  </a>
                  <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-800 font-medium bg-green-50 border-l-4 border-[#006837] p-4 rounded-r-lg mb-6">
                  <strong>B.Sc Nursing</strong> is a 4-year undergraduate degree program that trains learners to become registered nurses. In Tamil Nadu, over 190 colleges offer this INC-approved course affiliated to TNMGRMU. Eligibility requires 10+2 with PCB (45% minimum). Average starting salary: ₹3.5–4.5 LPA domestic, ₹15–25 LPA international (NHS UK, UAE).
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                    <span className="text-gray-700"><Link href="/faculty-details" className="hover:text-[#006837] hover:underline">Experienced Senior Learners</Link></span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                    <span className="text-gray-700">80+ Hospital Tie-ups</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
          ...
          <div className="container-custom">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                JKKN College of Nursing and Research combines clinical training in a 500+ bedded teaching hospital, published fees, and international career pathways for BSc Nursing in Tamil Nadu.
              </p>
            </div>
            ...
            <div className="overflow-x-auto mb-12">
              <table className="w-full max-w-2xl mx-auto border-collapse border border-gray-300 text-left">
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-50"><td className="border border-gray-300 p-3 font-medium">Minimum Marks</td><td className="border border-gray-300 p-3">45% aggregate (40% for BC/BCM/MBC & DNC and SC/SCA/ST)</td></tr>
              ...
              <div className="bg-white rounded-xl p-8 md:p-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Minimum 45% aggregate marks in PCB (40% for BC/BCM/MBC & DNC and SC/SCA/ST candidates).
                    </p>
                  </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-[#006837] text-white rounded-xl p-5 text-center">
                  ...
                  <p className="text-sm">Reserved for male learners per INC norms</p>
                </div>
                <div className="bg-[#006837] text-white rounded-xl p-5 text-center">
                  <div className="text-2xl font-bold text-[#7cb983] mb-1">Separate</div>
                  <p className="text-sm">Hostel facilities for male nursing learners</p>
                </div>
                <div className="bg-[#006837] text-white rounded-xl p-5 text-center">
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-[#7cb983] to-[#6ba872]">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=bsc-nursing" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-gray-100 text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
                Apply Now
                <span>→</span>
              </a>
