...
const config: CityPageConfig = {
  ...
  distanceSub:
    "about 1 to 1.5 hours by road via Erode; the campus is on NH-544 at Natarajapuram, Komarapalayam",
  ...
  reachRouteSummary: "72 km • about 1 to 1.5 hours",
  reachRoute:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Separate, secure hostels for boys and girls with mess facilities and warden supervision are available on campus. With Kangeyam about 1 to 1.5 hours away, learners can comfortably travel home on weekends and holidays.",
    },
    {
