...
const config: CityPageConfig = {
  ...
  heroStats: [
    ...
    { value: "35 km", label: "FROM PERUNDURAI" },
    { value: "3", label: "PROGRAMMES" },
  ],
  distanceKm: "~45",
  distanceHeading: "From Perundurai to JKKN Nursing",
  distanceSub:
    "about 30-40 minutes by road via Erode; both towns sit on the NH-544 Salem-Coimbatore corridor — campus at Natarajapuram, Komarapalayam",
  ...
  reachRouteSummary: "35 km • about 30-40 minutes",
  reachRoute:
