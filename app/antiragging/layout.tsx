...
export const metadata: Metadata = {
  title: "Anti-Ragging Undertaking — JKKN College of Nursing and Research",
  description:
    "Anti-ragging undertaking forms and helpline numbers for JKKN College of Nursing and Research.",
  openGraph: {
    title: "Anti-Ragging Undertaking — JKKN College of Nursing and Research",
    description:
      "Anti-ragging undertaking forms and helpline numbers for JKKN College of Nursing and Research.",
