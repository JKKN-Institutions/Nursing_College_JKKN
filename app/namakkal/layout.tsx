...
export const metadata: Metadata = {
  title: "Nursing College in Namakkal | JKKN Nursing",
  description:
    "Sresakthimayeil Institute of Nursing and Research near Namakkal on NH-544. INC-approved B.Sc, M.Sc & Post Basic B.Sc Nursing. 97% placements. Admissions open 2026-27.",
  openGraph: {
    title: "Nursing College in Namakkal | JKKN Nursing",
    description:
      "Sresakthimayeil Institute of Nursing and Research near Namakkal on NH-544. INC-approved B.Sc, M.Sc & Post Basic B.Sc Nursing. 97% placements. Admissions open 2026-27.",
...
export default function NamakkalLayout({
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(namakkalFaqSchema) }} />
      {children}
    </>
  );
}
