...
export default function MScChildHealthNursing() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=course-msc-child-health"
                  target="_blank"
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-transparent border-2 border-white hover:bg-white hover:text-[#006837] text-white px-8 py-3 rounded-full font-semibold transition-all"
                >
                  Explore Curriculum
                </button>
              </div>
      ...
      <section id="curriculum-structure" className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#006837] mb-4">
              ...
              <table className="w-full">
                ...
                <tbody>
                    <tr className="bg-[#7cb983]/10 border-b-2 border-[#7cb983]">
                      <td className="px-6 py-4 text-[#002309] text-lg">Annual Fee (Government &amp; Management Quota)</td>
                      <td className="px-6 py-4 text-right text-[#7cb983] text-lg">₹75,000</td>
                      <td className="px-6 py-4 text-right text-[#7cb983] text-lg">₹75,000</td>
                    </tr>
                  </tbody>
              </table>
