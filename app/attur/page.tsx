...
const config: CityPageConfig = {
  ...
  distanceSub:
    "about 1.5 hours by road via Salem and the NH-544 Salem-Coimbatore highway; the campus is at Natarajapuram, Komarapalayam",
  ...
  reachRouteSummary: "109 km • about 1.5 hours",
  reachRoute:
  ...
  reachRail:
    "Salem Junction is the major railhead (58 km from Attur); campus is 56 km from Salem Junction by road",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Separate, secure hostels for boys and girls with mess facilities and warden supervision are available on campus. Since Attur is about 1.5 hours away, most Attur learners stay in the hostel and travel home on longer weekends and holidays.",
    },
    {
  ...
  cities: [
    ...
    { name: "Rasipuram", distance: "60 km", href: "/rasipuram" },
