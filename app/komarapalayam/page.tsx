...
const config: CityPageConfig = {
  ...
  distanceKm: "0",
  distanceHeading: "The Campus Is in Komarapalayam Itself",
  distanceSub:
    "JKKN Nursing is located at Natarajapuram on NH-544, within Komarapalayam town — no long commute, no relocation needed",
  ...
  reachHeading: "How to Reach from Komarapalayam Town",
  reachRouteSummary: "Within town • NH-544, Natarajapuram",
  reachRoute:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "JKKN College of Nursing in Komarapalayam offers B.Sc Nursing (4 years, 100 seats), M.Sc Nursing (2 years, 30 seats), and Post Basic B.Sc Nursing (2 years, 50 seats). All programmes are INC approved and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai.",
    },
    {
    ...
    {
      q: "Can Komarapalayam learners study as day scholars?",
      a: "Yes. Since the campus is inside Komarapalayam town on NH-544, most local learners study as day scholars. Learners from surrounding villages can use college transport or opt for the separate boys' and girls' hostels on campus.",
    },
    {
      q: "Where exactly is the JKKN Nursing campus in Komarapalayam?",
      a: "The campus is at JKKN Institutions, Natarajapuram, NH-544 (Salem-Coimbatore National Highway), Komarapalayam (TK), Namakkal (DT), Tamil Nadu - 638183. Any NH-544 bus passing through Komarapalayam stops nearby.",
    },
    {
    ...
    },
    {
      ...
      a: "You can apply online through the official website at https://nursing.sresakthimayeil.jkkn.ac.in/, call the admission office at +91 93458 55001, or simply walk in to the campus at Natarajapuram, NH-544, Komarapalayam. Admissions for 2026-27 are currently open.",
    },
  ],
  cities: [
  ...
  areaServedSameAs: "https://en.wikipedia.org/wiki/Komarapalayam",
};
