        ...
        <div className="bg-[#FBFBEE] pb-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-16 max-w-[1400px]">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              Welcome to Sresakthimayeil Institute Of Nursing And Research! Our campus offers state-of-the-art facilities, including high-speed wifi connectivity, ensuring learners stay connected and engaged in their academic journey. With seamless internet access across the campus, learners can access online resources, research materials, and collaborate with peers effortlessly. Our robust wifi network enables innovative learning experiences, empowering learners to explore new ideas and stay ahead in a rapidly evolving world. Whether it&#39;s attending virtual learning sessions, participating in e-learning platforms, or connecting with senior learners, our reliable wifi infrastructure supports a dynamic and interactive learning environment. At Sresakthimayeil Institute Of Nursing And Research, we understand the importance of connectivity, and our dedicated IT team ensures smooth, uninterrupted access to the digital realm. Embrace the power of connectivity as you embark on a transformative educational experience at Sresakthimayeil Institute Of Nursing And Research!
            </p>
          </div>
        </div>
      </main>
