...
const config: CityPageConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "JKKN College of Nursing and Research near Tiruchengode offers B.Sc Nursing (4 years, 60 seats), M.Sc Nursing (2 years, 25 seats), and Post Basic B.Sc Nursing (2 years, 50 seats). All programmes are INC approved and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai.",
    },
    {
