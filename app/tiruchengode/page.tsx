...
const config: CityPageConfig = {
  ...
  heroDescription:
    "Looking for a nursing college near Tiruchengode? Sresakthimayeil Institute Of Nursing And Research (JKKN College of Nursing) in Komarapalayam is just 26 km away — in the same Namakkal district. INC-approved B.Sc Nursing, M.Sc Nursing, and Post Basic B.Sc programmes with hospital-based training.",
  heroStats: [
  ...
  landscapeParagraphs: [
    ...
    "For nursing aspirants here, JKKN College of Nursing (Sresakthimayeil Institute Of Nursing And Research) in Komarapalayam is one of the closest INC-approved options — about 26 km away by the direct Tiruchengode-Komarapalayam road, within the same Namakkal district. No relocation to Salem, Erode or Coimbatore is needed.",
    ...
    "Tiruchengode learners can commute daily (about 30-40 minutes by bus or two-wheeler) or choose the secure on-campus hostels with separate blocks for boys and girls. With 98% placement rate and international pathways (UK NHS, Gulf HAAD/DHA, Australia AHPRA), a global nursing career starts close to home.",
  ],
  whyHeading: "Why Tiruchengode Learners Choose JKKN — Same-District Nursing College",
  whyIntro:
    "JKKN College of Nursing is in Komarapalayam, the neighbouring taluk of the same Namakkal district — just 26 km from Tiruchengode. INC approved, NAAC accredited, hospital-attached, and easy to commute daily.",
  commuteDesc:
  ...
  faqs: [
    {
      ...
      a: "Sresakthimayeil Institute Of Nursing And Research (JKKN College of Nursing) in Komarapalayam is one of the nearest INC-approved nursing colleges to Tiruchengode — about 26 km away in the same Namakkal district. It is NAAC accredited and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai.",
    },
    {
      q: "How far is JKKN Nursing from Tiruchengode?",
      a: "JKKN College of Nursing is approximately 26 km from Tiruchengode via the direct Tiruchengode-Komarapalayam road — about 30-40 minutes. Regular buses ply between Tiruchengode bus stand and Komarapalayam all day.",
    },
    {
      q: "Are there nursing colleges in Namakkal district?",
      a: "Yes. JKKN College of Nursing (Sresakthimayeil Institute Of Nursing And Research) at Komarapalayam is an INC-approved, NAAC-accredited nursing college within Namakkal district, offering B.Sc Nursing, M.Sc Nursing and Post Basic B.Sc Nursing. For Tiruchengode learners it is a same-district option just 26 km away.",
    },
    {
      q: "What nursing courses are available near Tiruchengode?",
      a: "JKKN College of Nursing near Tiruchengode offers B.Sc Nursing (4 years, 60 seats), M.Sc Nursing (2 years, 25 seats), and Post Basic B.Sc Nursing (2 years, 50 seats). All programmes are INC approved and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai.",
    },
    {
    ...
    },
    {
      ...
      a: "Both options work. Many Tiruchengode learners commute daily since the campus is only about 30-40 minutes away. Separate, secure hostels for boys and girls with mess facilities are available for learners who prefer to stay on campus.",
    },
    {
...
export const metadata: Metadata = {
  ...
  description:
    "Nursing college near Tiruchengode: JKKN College of Nursing in Komarapalayam is 26 km away, in the same Namakkal district. INC approved, NAAC accredited. B.Sc, M.Sc, Post Basic B.Sc Nursing. Admissions 2026-27 open.",
  keywords:
  ...
  openGraph: {
    title: "Nursing College near Tiruchengode | B.Sc Nursing — JKKN",
    description:
      "JKKN College of Nursing in Komarapalayam is 26 km from Tiruchengode, same Namakkal district. INC approved, NAAC accredited. Admissions 2026-27 open.",
