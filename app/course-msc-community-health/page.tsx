            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="bg-white/10 border-l-4 border-[#7cb983] p-4 mb-6 rounded-r-lg">
                  ...
                  <p className="text-cyan-100 text-sm">JKKN College of Nursing and Research offers a 2-year M.Sc Nursing specialization in Community Health Nursing, approved by INC and affiliated to Tamil Nadu Dr. M.G.R. Medical University. Graduates lead public health initiatives, design epidemiological interventions, and deliver community-based primary healthcare across urban and rural settings in Tamil Nadu and beyond.</p>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=course-msc-community-health" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg transition-all duration-300 shadow-lg flex items-center gap-2">
                    Apply Now →
                  </a>
                  <button
                    onClick={() => {
                ...
                <div className="bg-[#006837]/30 backdrop-blur-sm rounded-2xl p-8 border border-[#7cb983]/30">
                  <div className="rounded-xl aspect-video overflow-hidden mb-6">
                    <Image
                      ...
                      alt="M.Sc Community Health Nursing students in practical field training at JKKN College of Nursing and Research"
                      width={600}
                      height={338}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl min-h-[400px]">
                <Image
                  ...
                  alt="M.Sc Community Health Nursing students in field training session at JKKN College of Nursing and Research"
                  fill
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tr className="bg-[#7cb983]/10 border-b-2 border-[#7cb983]">
                      <td className="px-6 py-4 text-lg">Annual Fee (Government &amp; Management Quota)</td>
                      <td className="px-6 py-4 text-center text-lg">₹75,000</td>
                      <td className="px-6 py-4 text-center text-lg">₹75,000</td>
                    </tr>
                  </tbody>
                  </table>
          ...
          <div className="container-custom">
            <div className="text-center text-white">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-12 mt-8">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=nursing.sresakthimayeil.jkkn.ac.in&utm_medium=organic&utm_campaign=course-msc-community-health" target="_blank" rel="noopener noreferrer" className="bg-white text-[#006837] hover:bg-[#FBFBEE] font-bold px-8 py-4 rounded-full transition-all duration-300 shadow-lg flex items-center gap-2 text-lg">
