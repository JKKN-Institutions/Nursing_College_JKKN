...
export const metadata: Metadata = {
  title: "Public Self-Disclosure — JKKN College of Nursing and Research",
  description:
    "Mandatory public self-disclosure documents and institutional data for JKKN College of Nursing and Research.",
  openGraph: {
    title: "Public Self-Disclosure — JKKN College of Nursing and Research",
    description:
      "Mandatory public self-disclosure documents and institutional data for JKKN College of Nursing and Research.",
