...
export default function IIC() {
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-4 sm:mb-6">Institution's Innovation Council (IIC) — JKKN College of Nursing and Research</h1>
