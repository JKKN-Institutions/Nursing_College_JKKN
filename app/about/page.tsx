...
export const metadata: Metadata = {
  ...
  description: "About Sresakthimayeil Institute Of Nursing And Research (Sresakthimayeil Institute Of Nursing And Research), Komarapalayam, Tamil Nadu. Established 2006, INC-approved, affiliated to TNMGRMU.",
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-16 py-6 sm:py-8">
      ...
      <section className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Sresakthimayeil Institute Of Nursing And Research is part of the JKKN Institutions campus, which includes an attached multi-specialty teaching hospital providing learners with clinical exposure from the first year. The campus features advanced nursing learning labs, a well-stocked learning commons, smart learning studios, separate hostel facilities for men and women, sports facilities, Wi-Fi enabled campus, cafeteria, learning auditorium, and dedicated transport services.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          The college is located on the Salem-Coimbatore National Highway (NH-544) at Komarapalayam in Namakkal district, Tamil Nadu. By road the campus is about 22 km from Erode, 26 km from Tiruchengode, 57 km from Salem, 62 km from Namakkal and 113 km from Coimbatore.
        </p>
