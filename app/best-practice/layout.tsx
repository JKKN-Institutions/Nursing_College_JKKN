...
export const metadata: Metadata = {
  title: "Best Practices — JKKN College of Nursing and Research",
  description:
    "Best practices in nursing education and institutional development at JKKN College of Nursing and Research.",
  openGraph: {
    title: "Best Practices — JKKN College of Nursing and Research",
    description:
      "Best practices in nursing education and institutional development at JKKN College of Nursing and Research.",
