...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Best Nursing College in Tiruppur | B.Sc Nursing Near Tiruppur — JKKN",
    description:
      "Looking for the best nursing college in Tiruppur? JKKN College of Nursing offers INC approved, NAAC accredited nursing programmes. 90%+ placements.",
        ...
        <section className="bg-gradient-to-br from-[#006837] via-[#002309] to-[#002309] py-12 sm:py-16 md:py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <a
                href="https://admission.jkkn.ac.in/form/jkkn-institution-admission-yxs3w8?utm_source=website&utm_medium=city_page&utm_campaign=tiruppur"
