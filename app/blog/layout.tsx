...
export const metadata: Metadata = {
  title: "Nursing Blog — JKKN College of Nursing and Research",
  description:
    "Nursing tips, health insights, career guidance, and campus updates from JKKN College of Nursing and Research.",
  openGraph: {
    title: "Nursing Blog — JKKN College of Nursing and Research",
    description:
      "Nursing tips, health insights, career guidance, and campus updates from JKKN College of Nursing and Research.",
...
const collectionPageSchema = {
  ...
  "@type": "CollectionPage",
  "name": "Nursing Blog — JKKN College of Nursing and Research",
  "description": "Nursing tips, health insights, career guidance, and campus updates from JKKN College of Nursing and Research.",
  "url": "https://nursing.sresakthimayeil.jkkn.ac.in/blog",
  "isPartOf": {
    "@type": "WebSite",
