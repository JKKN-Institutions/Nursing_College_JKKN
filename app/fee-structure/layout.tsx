...
export const metadata: Metadata = {
  ...
  description: "JKKN College of Nursing fee structure: B.Sc Nursing ₹95,000/year, M.Sc Nursing ₹1,25,000/year, Post Basic B.Sc ₹85,000/year. Hostel, scholarships, loan info.",
  ...
  twitter: {
    ...
    title: "Fee Structure 2026-27 — B.Sc, M.Sc Nursing Fees | JKKN",
    description: "Complete fee structure for nursing programs at JKKN College of Nursing.",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The annual tuition fee for B.Sc Nursing at JKKN College of Nursing is ₹95,000 per year. The total course fee for the 4-year program is ₹3,80,000.",
      },
    },
    {
      "@type": "Question",
      "name": "What is the hostel fee at JKKN College of Nursing?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does JKKN College of Nursing help with education loans?",
      "acceptedAnswer": {
        "@type": "Answer",
